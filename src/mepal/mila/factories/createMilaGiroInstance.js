...
export const MILA_GIRO_DEFINITIONS = {
  ...
  45: {
    ...
    grommetCode: '22000127787',
    label: 'Superficie Giro 45°',
    description: 'SUPERFICIE GIRO 45 GRADOS FORMICA TEK SOCIAL (MILA V2) TKSSU140000',
    prices: { CO: 491400, USD: 70, EUC: 136 },
  ...
  60: {
    ...
    grommetCode: '22000127785',
    label: 'Superficie Giro 60°',
    description: 'SUPERFICIE GIRO 60 GRADOS FORMICA TEK SOCIAL (MILA V2) TKSSU060000',
    prices: { CO: 623700, USD: 88, EUC: 172 },
  ...
  120: {
    ...
    description: 'SUPERFICIE GIRO 120 GRADOS FORMICA TEK SOCIAL (MILA V2) TKSSU130000',
    prices: { CO: 623700, USD: 88, EUC: 172 },
  ...
  135: {
    ...
    description: 'SUPERFICIE GIRO 135 GRADOS FORMICA TEK SOCIAL (MILA V2) TKSSU040000_135',
    prices: { CO: 491400, USD: 70, EUC: 136 },
  ...
  150: {
    ...
    grommetCode: '22000127789',
    label: 'Superficie Giro 150°',
    description: 'SUPERFICIE ESQUINERA FORMICA TEK SOCIAL (MILA V2) TKSSU150000',
    prices: { CO: 593250, USD: 84, EUC: 164 },
  ...
  180: {
    ...
    grommetCode: '22000127783',
    label: 'Superficie Giro 180°',
    description: 'SUPERFICIE RECTANGULAR 60 X 70 FORMICA TEK SOCIAL (MILA V2) TKSSU120000',
    prices: { CO: 465150, USD: 66, EUC: 129 },
